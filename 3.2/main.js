...
var _user$project$Main$toPositions = _elm_lang$core$List$indexedMap(
	F2(
		function (i, x) {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$toFloat(i) * 10,
				_1: _elm_lang$core$Basics$toFloat(x)
			};
		}));
				...
				A2(
					...
					A2(
						...
						_evancz$elm_graphics$Collage$path(
							_user$project$Main$toPositions(
								_user$project$Main$accumulate(model))))))));
};
var _user$project$Main$RandomInts = function (a) {
	return {ctor: 'RandomInts', _0: a};
};
var _user$project$Main$init = {
	...
	_1: A2(
		_elm_lang$core$Random$generate,
		_user$project$Main$RandomInts,
		A2(
			_elm_lang$core$Random$list,
			50,
			A2(_elm_lang$core$Random$int, -10, 10)))
};
