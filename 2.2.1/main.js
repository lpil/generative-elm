...
var _user$project$Main$background = A2(
	...
	_elm_lang$core$Color$greyscale(0.1),
	A2(_evancz$elm_graphics$Collage$rect, 500, 300));
var _user$project$Main$lineStyle = _elm_lang$core$Native_Utils.update(
	_evancz$elm_graphics$Collage$defaultLine,
	{
		width: 4,
		cap: _evancz$elm_graphics$Collage$Round,
		color: A3(_elm_lang$core$Color$rgb, 130, 0, 0)
	});
var _user$project$Main$line = F2(
	function (origin, destination) {
		return A2(
			_evancz$elm_graphics$Collage$traced,
			_user$project$Main$lineStyle,
			A2(_evancz$elm_graphics$Collage$segment, origin, destination));
	});
var _user$project$Main$cross = _evancz$elm_graphics$Collage$group(
	{
		ctor: '::',
		_0: A2(
			_user$project$Main$line,
			{ctor: '_Tuple2', _0: -70, _1: -70},
			{ctor: '_Tuple2', _0: 70, _1: 70}),
		_1: {
			ctor: '::',
			_0: A2(
...
var _user$project$Main$faintCircle = _evancz$elm_graphics$Collage$group(
	{
		ctor: '::',
		_0: A2(
			_evancz$elm_graphics$Collage$filled,
			A4(_elm_lang$core$Color$rgba, 255, 255, 255, 0.6),
			_evancz$elm_graphics$Collage$circle(25)),
		_1: {
			ctor: '::',
			_0: A2(
	...
	_evancz$elm_graphics$Element$toHtml(
		A3(
			...
			300,
			{
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$cross,
					_1: {
						ctor: '::',
						_0: _user$project$Main$faintCircle,
						_1: {ctor: '[]'}
					}
				}
			})));
