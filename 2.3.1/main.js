...
var _user$project$Main$sizedCircle = function (diameter) {
...
var _user$project$Main$greyBackground = A2(
	_evancz$elm_graphics$Collage$filled,
...
var _user$project$Main$view = function (model) {
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			{
				ctor: '::',
				_0: _user$project$Main$greyBackground,
				_1: {
					ctor: '::',
					_0: _user$project$Main$sizedCircle(model.diameter),
					_1: {ctor: '[]'}
				}
			}));
};
...
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, (1000 / 60) * _elm_lang$core$Time$millisecond, _user$project$Main$Tick);
};
