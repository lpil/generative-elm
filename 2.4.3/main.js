...
var _user$project$Main$growingWhite = function (x) {
	return A4(
		_elm_lang$core$Color$rgba,
		255,
		255,
		255,
		_elm_lang$core$Basics$toFloat(x * 10) / 255);
};
var _user$project$Main$fadingBlack = function (x) {
	return A4(
		_elm_lang$core$Color$rgba,
		0,
		0,
		0,
		_elm_lang$core$Basics$toFloat(255 - (x * 10)) / 255);
};
...
var _user$project$Main$lineStyle = function (color) {
	return _elm_lang$core$Native_Utils.update(
		_evancz$elm_graphics$Collage$defaultLine,
		{width: 5, color: color});
};
var _user$project$Main$lines = F2(
	function (numLines, makeColor) {
			...
			A2(
				...
				function (x) {
					return A2(
						...
						_elm_lang$core$Basics$toFloat(140 - (x * 10)),
						A2(
							...
							A2(
								...
								{ctor: '_Tuple2', _0: 240, _1: 0},
								{ctor: '_Tuple2', _0: -240, _1: 0})));
				},
				A2(_elm_lang$core$List$range, 0, numLines)));
	});
			...
			300,
			{
				...
				_1: {
					...
					_0: A2(
						_evancz$elm_graphics$Collage$moveY,
						0,
						A2(_user$project$Main$lines, 28, _user$project$Main$fadingBlack)),
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$elm_graphics$Collage$moveY,
							-5,
							A2(_user$project$Main$lines, 27, _user$project$Main$growingWhite)),
						_1: {ctor: '[]'}
					}
				}
			})));
