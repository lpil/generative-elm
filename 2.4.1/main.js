...
var _user$project$View$ring = function (radius) {
	return A2(
		_evancz$elm_graphics$Collage$outlined,
		_elm_lang$core$Native_Utils.update(
			_evancz$elm_graphics$Collage$defaultLine,
			{color: _elm_lang$core$Color$charcoal}),
		_evancz$elm_graphics$Collage$circle(
			_elm_lang$core$Basics$toFloat(radius)));
};
var _user$project$View$rings = function (diameter) {
	return _evancz$elm_graphics$Collage$group(
		A2(
			_elm_lang$core$List$map,
			_user$project$View$ring,
			A2(
				_elm_lang$core$List$map,
				function (x) {
					return x * 5;
				...
				A2(
					_elm_lang$core$List$range,
					1,
					_elm_lang$core$Basics$truncate(((diameter - 1) / 5) / 2)))));
};
var _user$project$View$sizedCircle = function (diameter) {
	return _evancz$elm_graphics$Collage$group(
		{
			ctor: '::',
			_0: A2(
				_evancz$elm_graphics$Collage$filled,
				A4(_elm_lang$core$Color$rgba, 255, 255, 255, 0.6),
				_evancz$elm_graphics$Collage$circle(diameter * 0.5)),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$elm_graphics$Collage$outlined,
...
var _user$project$View$greyBackground = A2(
	_evancz$elm_graphics$Collage$filled,
	A3(_elm_lang$core$Color$rgb, 150, 150, 150),
	A2(_evancz$elm_graphics$Collage$rect, 500, 300));
var _user$project$View$root = function (model) {
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			{
				ctor: '::',
				_0: _user$project$View$greyBackground,
				_1: {
					ctor: '::',
					_0: _user$project$View$sizedCircle(model.diameter),
					_1: {
						ctor: '::',
						_0: _user$project$View$rings(model.diameter),
						_1: {ctor: '[]'}
					}
				}
			}));
	...
	function (msg, model) {
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					diameter: A2(_elm_lang$core$Basics$min, model.diameter + 10, 400)
				}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, (1000 / 60) * _elm_lang$core$Time$millisecond, _user$project$Types$Tick);
};
