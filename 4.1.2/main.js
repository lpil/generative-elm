...
var _user$project$Main$point = function (i) {
	var degs = i * 10;
	var rads = _elm_lang$core$Basics$degrees(
		_elm_lang$core$Basics$toFloat(degs));
	var radiusStep = 0.5;
	var radius = 10 + (_elm_lang$core$Basics$toFloat(i) * radiusStep);
	var x = radius * _elm_lang$core$Basics$cos(rads);
	var y = 0 - (radius * _elm_lang$core$Basics$sin(rads));
	return {ctor: '_Tuple2', _0: x, _1: y};
};
var _user$project$Main$spiral = A2(
	_evancz$elm_graphics$Collage$traced,
	_elm_lang$core$Native_Utils.update(
		_evancz$elm_graphics$Collage$defaultLine,
		{width: 4, cap: _evancz$elm_graphics$Collage$Round}),
	_evancz$elm_graphics$Collage$path(
		A2(
			...
			A2(
				_elm_lang$core$List$range,
				0,
				_elm_lang$core$Basics$truncate(1440 / 10)))));
